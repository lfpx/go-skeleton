...
### `/db`
contains the code to initialize database connections and perform migrations

### `/models` 
contains all model definitions and potential model-related logic

### `/seeds` 
contains the code to initially seed the database with some data
